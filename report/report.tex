...
\noindent\textbf{Current research pivot.}
This report is retained as historical background for the older blended Hybrid
LQR-MPC controller. The blended hybrid method is now treated as a baseline only,
because direct switching or convex command blending does not guarantee
preservation of MPC obstacle-avoidance constraints. The current paper direction
is Risk-Triggered Adaptive MPC Safety Filtering with LQR Nominal Control.
