...
\begin{warningbox}[Current Research Pivot]
This document is retained as exploratory background. The older switching or
blended Hybrid LQR-MPC logic is now treated as a baseline only, not as the final
publication method. The current method is Risk-Triggered Adaptive MPC Safety
Filtering with LQR Nominal Control.
\end{warningbox}
