#!/usr/bin/env python3
"""
Launch: TurtleBot3 + Pure Adaptive MPC Controller + Obstacles + RViz
====================================================================

Launches the adaptive MPC controller (CasADi + IPOPT with LMS online
parameter adaptation) for trajectory tracking and obstacle avoidance.
"""
...
def generate_launch_description():
    ...
    # Pure Adaptive MPC Controller Node
    adaptive_mpc_controller = Node(
        package='hybrid_nav',
        executable='adaptive_mpc_controller_node',
        name='adaptive_mpc_controller_node',
        output='screen',
    ...
    ld.add_action(adaptive_mpc_controller)
