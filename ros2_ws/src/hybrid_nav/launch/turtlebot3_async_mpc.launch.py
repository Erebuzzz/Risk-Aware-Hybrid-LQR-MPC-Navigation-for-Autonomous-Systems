#!/usr/bin/env python3
"""
Launch: TurtleBot3 + Async Adaptive MPC Controller + Obstacles + RViz
=====================================================================

Uses the threaded async_mpc_controller_node which decouples the MPC
solver from the 20 Hz cmd_vel publisher for jitter-free control.
"""
...
def generate_launch_description():
    ...
    async_mpc_controller = Node(
        package='hybrid_nav',
        executable='async_mpc_controller_node',
        name='async_mpc_controller_node',
        output='screen',
    ...
    ld.add_action(async_mpc_controller)
